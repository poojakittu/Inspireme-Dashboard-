...
const AllreturnPolicies = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "https://shy-cyan-bear-tie.cyclic.app/returnpolicy"
      );
  ...
  const handleSave = async () => {
    if (editIndex !== null) {
      try {
        await axios.put(
          `https://shy-cyan-bear-tie.cyclic.app/returnpolicy/${content[editIndex]._id}`,
          {
      ...
      try {
        await axios.delete(
          `https://shy-cyan-bear-tie.cyclic.app/returnpolicy/${content[deleteIndex]._id}`
        );
...
export default AllreturnPolicies;
