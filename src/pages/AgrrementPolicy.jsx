...
const AllAggrementPolicies = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "https://shy-cyan-bear-tie.cyclic.app/agreemet"
      );
  ...
  const handleSave = async () => {
    if (editIndex !== null) {
      try {
        await axios.put(
          `https://shy-cyan-bear-tie.cyclic.app/agreemet/${content[editIndex]._id}`,
          {
      ...
      try {
        await axios.delete(
          `https://shy-cyan-bear-tie.cyclic.app/agreemet/${content[deleteIndex]._id}`
        );
...
export default AllAggrementPolicies;
