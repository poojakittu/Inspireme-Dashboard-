...
const AllBeforePolicy = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "https://shy-cyan-bear-tie.cyclic.app/beforePolicy"
      );
  ...
  const handleSave = async () => {
    if (editIndex !== null) {
      try {
        await axios.put(
          `https://shy-cyan-bear-tie.cyclic.app/beforePolicy/${content[editIndex]._id}`,
          {
      ...
      try {
        await axios.delete(
          `https://shy-cyan-bear-tie.cyclic.app/beforePolicy/${content[deleteIndex]._id}`
        );
...
export default AllBeforePolicy;
